...
| 2026-03-02 | 🔵 진행중 | PassiveSelectionUIComponent.mlua 런타임 경로 동기화 및 클릭 콜백 재수정 |
| 2026-03-02 | 🟢 완료 | 패시브 선택 클릭 입력 복구 및 패널 자동 닫힘 가드 반영 |
| 2026-03-02 | 🔵 진행중 | 패시브 획득 미동작 원인 추적용 디버그 로그 라인 추가 |
| 2026-03-02 | 🟢 완료 | 드롭/선택 UI/패시브 서버 적용 경로 단계별 로그 추가 및 codeblock 동기화 |
| 2026-03-02 | 🔵 진행중 | `Click ignored: option not clickable` 로그 기준으로 UI 오픈-렌더 순서 버그 분석 |
| 2026-03-02 | 🟢 완료 | `OpenPassiveSelectionClient`에서 가시화 후 렌더 순서로 교정하여 옵션 클릭 가능 상태 복구(.mlua/.codeblock 동기화) |
